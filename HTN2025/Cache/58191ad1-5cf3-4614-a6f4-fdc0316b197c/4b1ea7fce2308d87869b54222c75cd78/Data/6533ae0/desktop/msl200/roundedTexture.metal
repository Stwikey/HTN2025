...
{
main_frag_out out={};
float N2_objectWidth=0.0;
float N2_objectHeight=0.0;
float N2_outlineThickness=0.0;
float4 N2_boxColor=float4(0.0);
float4 N2_outlineColor=float4(0.0);
float3 N2_objPos=float3(0.0);
float4 N2_ResultColor=float4(0.0);
...
float4 FinalColor=float4(0.14902,0.14902,0.14902,1.0);
ssGlobals Globals;
...
float Output_N1=0.0;
float param_1=(*sc_set0.UserUniforms).aspect;
Output_N1=param_1;
float Output_N5=0.0;
float param_2=(*sc_set0.UserUniforms).outlineThickness;
Output_N5=param_2;
...
int param_4=l9_6;
float2 param_5=Globals.Surface_UVCoord0;
bool param_6=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 param_7=(*sc_set0.UserUniforms).baseTexTransform;
...
float4 param_10=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool param_11=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).baseTexBorderColor;
float param_13=0.0;
bool l9_7=param_11&&(!param_9);
float l9_8=1.0;
float l9_9=param_5.x;
int l9_10=param_8.x;
if (l9_10==1)
{
l9_9=fract(l9_9);
...
float l9_21=param_5.x;
float l9_22=param_10.x;
float l9_23=param_10.z;
bool l9_24=l9_20;
float l9_25=l9_8;
...
float l9_30=param_5.y;
float l9_31=param_10.y;
float l9_32=param_10.w;
bool l9_33=l9_29;
float l9_34=l9_8;
...
float2 l9_37=param_5;
bool l9_38=param_6;
float3x3 l9_39=param_7;
if (l9_38)
{
...
param_5.y=l9_52;
l9_8=l9_55;
float2 l9_63=param_5;
int l9_64=param_3;
int l9_65=param_4;
float l9_66=param_13;
float2 l9_67=l9_63;
int l9_68=l9_64;
int l9_69=l9_65;
...
if (param_11)
{
l9_74=mix(param_12,l9_74,float4(l9_8));
}
float4 l9_75=l9_74;
Output_N3=l9_75;
float4 Output_N6=float4(0.0);
float4 param_14=(*sc_set0.UserUniforms).outlineColor;
Output_N6=param_14;
float3 Position_N0=float3(0.0);
Position_N0=Globals.SurfacePosition_ObjectSpace;
float4 ResultColor_N2=float4(0.0);
float param_15=(*sc_set0.UserUniforms).Port_objectWidth_N002;
float param_16=Output_N1;
float param_17=Output_N5;
float4 param_18=Output_N3;
float4 param_19=Output_N6;
float3 param_20=Position_N0;
float4 param_21=float4(0.0);
N2_objectWidth=param_15;
N2_objectHeight=param_16;
N2_outlineThickness=param_17;
N2_boxColor=param_18;
N2_outlineColor=param_19;
N2_objPos=param_20;
float2 l9_76=float2(N2_objPos.x*N2_objectWidth,N2_objPos.y*N2_objectHeight);
float2 l9_77=float2(N2_objectWidth,N2_objectHeight)*0.5;
float l9_78=fast::min(N2_objectWidth,N2_objectHeight)*0.1;
float2 l9_79=l9_76;
float2 l9_80=l9_77;
float l9_81=l9_78;
float2 l9_82=abs(l9_79)-(l9_80-float2(l9_81));
float l9_83=(length(fast::max(l9_82,float2(0.0)))+fast::min(fast::max(l9_82.x,l9_82.y),0.0))-l9_81;
float l9_84=l9_83;
float l9_85=N2_objectWidth*N2_outlineThickness;
if (l9_84>0.0)
{
discard_fragment();
}
...
if (l9_84>(-l9_85))
{
N2_ResultColor=N2_outlineColor;
}
else
{
N2_ResultColor=N2_boxColor;
}
}
param_21=N2_ResultColor;
ResultColor_N2=param_21;
FinalColor=ResultColor_N2;
...
{
float4 l9_86=gl_FragCoord;
float2 l9_87=floor(mod(l9_86.xy,float2(4.0)));
float l9_88=(mod(dot(l9_87,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_22<l9_88)
{
discard_fragment();
}
...
float4 l9_89=fast::max(param_23,float4(0.0));
float4 param_24=l9_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float2 l9_104=l9_103.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_109=l9_108;
int l9_110=l9_109;
float3 l9_111=float3(l9_105,0.0);
int l9_112=l9_107;
int l9_113=l9_110;
if (l9_112==1)
{
l9_111.y=((2.0*l9_111.y)+float(l9_113))-1.0;
}
float2 l9_114=l9_111.xy;
l9_106=l9_114;
}
else
{
...
int l9_127=sc_ScreenTextureLayout_tmp;
int l9_128=l9_125;
float l9_129=l9_119;
...
float4 l9_136=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_135.xy,bias(l9_129));
float4 l9_137=l9_136;
float4 l9_138=l9_137;
l9_100=l9_138;
}
float4 l9_139=l9_100;
float3 l9_140=l9_139.xyz;
float3 l9_141=l9_140;
float3 l9_142=l9_98.xyz;
float3 l9_143=definedBlend(l9_141,l9_142,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_99=float4(l9_143.x,l9_143.y,l9_143.z,l9_99.w);
float3 l9_144=mix(l9_140,l9_99.xyz,float3(l9_98.w));
l9_99=float4(l9_144.x,l9_144.y,l9_144.z,l9_99.w);
l9_99.w=1.0;
float4 l9_145=l9_99;
param_25=l9_145;
}
...
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_146=float4(in.varScreenPos.xyz,1.0);
param_25=l9_146;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_147=gl_FragCoord;
float l9_148=fast::clamp(abs(l9_147.z),0.0,1.0);
float4 l9_149=float4(l9_148,1.0-l9_148,1.0,1.0);
param_25=l9_149;
}
else
{
float4 l9_150=param_25;
float4 l9_151=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_151=float4(mix(float3(1.0),l9_150.xyz,float3(l9_150.w)),l9_150.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_152=l9_150.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_152=fast::clamp(l9_152,0.0,1.0);
}
l9_151=float4(l9_150.xyz*l9_152,l9_152);
}
else
{
l9_151=l9_150;
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_26,param_27,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_28=FinalColor;
float4 l9_157=param_28;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_157.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_157;
return out;
}
} // FRAGMENT SHADER
