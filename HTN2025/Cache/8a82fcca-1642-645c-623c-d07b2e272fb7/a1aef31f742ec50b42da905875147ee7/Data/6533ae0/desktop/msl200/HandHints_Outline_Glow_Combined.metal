...
//sampler sampler Tweak_N6SmpSC 0:24
...
//texture texture2D Tweak_N6 0:5:0:24
...
//float Tweak_N44 4384
//float fadeLevel 4388
//float3x3 Tweak_N6Transform 4448
//float4 Tweak_N6UvMinMax 4496
//float4 Tweak_N6BorderColor 4512
//float glowIntensity 4528
//float3x3 Tweak_N0Transform 4592
//float4 Tweak_N0UvMinMax 4640
//float4 Tweak_N0BorderColor 4656
//float opacityIntensity 4672
//float3 Port_Normal_N041 4688
//float4 Port_Value_N017 4704
//float depthRef 4724
//}
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N6 [[function_constant(35)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N6 [[function_constant(38)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(79)]];
...
constant int Tweak_N6Layout [[function_constant(82)]];
...
float4 Port_Value_N017;
float Port_Mask_N011;
float depthRef;
};
struct sc_Bone_t
{
...
float param_1=(*sc_set0.UserUniforms).Tweak_N44;
Output_N44=param_1;
float Output_N45=0.0;
float param_2=(*sc_set0.UserUniforms).fadeLevel;
Output_N45=param_2;
float Rim_N41=0.0;
float3 param_3=(*sc_set0.UserUniforms).Port_Normal_N041;
float param_4=Output_N44;
...
float l9_1=abs(dot(-param_7.ViewDirWS,param_3));
float param_6=pow(1.0-l9_1,param_4);
param_6=fast::max(param_6,0.0);
param_6*=param_5;
Rim_N41=param_6;
float4 Output_N17=float4(0.0);
Output_N17=(*sc_set0.UserUniforms).Port_Value_N017;
...
int l9_7=l9_2;
int param_8=Tweak_N6Layout_tmp;
int param_9=l9_7;
float2 param_10=Globals.Surface_UVCoord0;
bool param_11=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_12=(*sc_set0.UserUniforms).Tweak_N6Transform;
int2 param_13=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_14=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_18=0.0;
bool l9_8=param_16&&(!param_14);
float l9_9=1.0;
float l9_10=param_10.x;
int l9_11=param_13.x;
if (l9_11==1)
{
l9_10=fract(l9_10);
}
...
param_10.x=l9_10;
float l9_15=param_10.y;
int l9_16=param_13.y;
if (l9_16==1)
{
l9_15=fract(l9_15);
}
...
float l9_22=param_10.x;
float l9_23=param_15.x;
float l9_24=param_15.z;
bool l9_25=l9_21;
float l9_26=l9_9;
...
float l9_31=param_10.y;
float l9_32=param_15.y;
float l9_33=param_15.w;
bool l9_34=l9_30;
float l9_35=l9_9;
...
float2 l9_38=param_10;
bool l9_39=param_11;
float3x3 l9_40=param_12;
if (l9_39)
{
...
float2 l9_41=l9_38;
param_10=l9_41;
float l9_42=param_10.x;
int l9_43=param_13.x;
bool l9_44=l9_8;
float l9_45=l9_9;
if ((l9_43==0)||(l9_43==3))
{
...
param_10.x=l9_42;
l9_9=l9_45;
float l9_53=param_10.y;
int l9_54=param_13.y;
bool l9_55=l9_8;
float l9_56=l9_9;
if ((l9_54==0)||(l9_54==3))
{
...
param_10.y=l9_53;
l9_9=l9_56;
float2 l9_64=param_10;
int l9_65=param_8;
int l9_66=param_9;
float l9_67=param_18;
float2 l9_68=l9_64;
int l9_69=l9_65;
int l9_70=l9_66;
...
float3 l9_72=l9_71;
float3 l9_73=l9_72;
float4 l9_74=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_73.xy,bias(l9_67));
float4 l9_75=l9_74;
if (param_16)
{
l9_75=mix(param_17,l9_75,float4(l9_9));
}
float4 l9_76=l9_75;
Output_N6=l9_76;
float4 Output_N12=float4(0.0);
Output_N12=Output_N17+Output_N6;
float Output_N20=0.0;
float param_19=(*sc_set0.UserUniforms).glowIntensity;
Output_N20=param_19;
float4 Output_N7=float4(0.0);
Output_N7=((Output_N12*Output_N6)*Output_N17)*float4(Output_N20);
float4 Output_N11=float4(0.0);
float4 param_21=float4(Rim_N41);
float4 param_22=Output_N7;
float4 l9_77=param_21;
float4 l9_78=param_22;
float3 l9_79=l9_77.xyz*l9_77.w;
l9_77=float4(l9_79.x,l9_79.y,l9_79.z,l9_77.w);
float4 param_20=fast::min(l9_77+l9_78,float4(1.0));
Output_N11=param_20;
float Value1_N31=0.0;
float Value2_N31=0.0;
float Value3_N31=0.0;
float4 param_23=Output_N11;
...
int l9_85=l9_80;
int param_27=Tweak_N0Layout_tmp;
int param_28=l9_85;
float2 param_29=Globals.Surface_UVCoord1;
bool param_30=(int(SC_USE_UV_TRANSFORM_Tweak_N0_tmp)!=0);
float3x3 param_31=(*sc_set0.UserUniforms).Tweak_N0Transform;
int2 param_32=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0_tmp);
bool param_33=(int(SC_USE_UV_MIN_MAX_Tweak_N0_tmp)!=0);
float4 param_34=(*sc_set0.UserUniforms).Tweak_N0UvMinMax;
bool param_35=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0_tmp)!=0);
float4 param_36=(*sc_set0.UserUniforms).Tweak_N0BorderColor;
float param_37=0.0;
bool l9_86=param_35&&(!param_33);
float l9_87=1.0;
float l9_88=param_29.x;
int l9_89=param_32.x;
if (l9_89==1)
{
l9_88=fract(l9_88);
}
...
param_29.x=l9_88;
float l9_93=param_29.y;
int l9_94=param_32.y;
if (l9_94==1)
{
l9_93=fract(l9_93);
}
...
float l9_100=param_29.x;
float l9_101=param_34.x;
float l9_102=param_34.z;
bool l9_103=l9_99;
float l9_104=l9_87;
...
float l9_109=param_29.y;
float l9_110=param_34.y;
float l9_111=param_34.w;
bool l9_112=l9_108;
float l9_113=l9_87;
...
float2 l9_116=param_29;
bool l9_117=param_30;
float3x3 l9_118=param_31;
if (l9_117)
{
...
param_29=l9_119;
float l9_120=param_29.x;
int l9_121=param_32.x;
bool l9_122=l9_86;
float l9_123=l9_87;
...
param_29.x=l9_120;
l9_87=l9_123;
float l9_131=param_29.y;
int l9_132=param_32.y;
bool l9_133=l9_86;
float l9_134=l9_87;
...
param_29.y=l9_131;
l9_87=l9_134;
float2 l9_142=param_29;
int l9_143=param_27;
int l9_144=param_28;
float l9_145=param_37;
...
float3 l9_151=l9_150;
float4 l9_152=sc_set0.Tweak_N0.sample(sc_set0.Tweak_N0SmpSC,l9_151.xy,bias(l9_145));
float4 l9_153=l9_152;
if (param_35)
{
l9_153=mix(param_36,l9_153,float4(l9_87));
}
float4 l9_154=l9_153;
Output_N0=l9_154;
float Output_N3=0.0;
float param_38=(*sc_set0.UserUniforms).opacityIntensity;
Output_N3=param_38;
float4 Output_N2=float4(0.0);
Output_N2=Output_N0*float4(Output_N3);
float4 Value_N32=float4(0.0);
Value_N32.x=Value1_N31;
Value_N32.y=Value2_N31;
Value_N32.z=Value3_N31;
Value_N32.w=Output_N2.x;
FinalColor=Value_N32;
...
float4 l9_158=fast::max(param_40,float4(0.0));
float4 param_41=l9_158;
if (sc_ShaderCacheConstant_tmp!=0)
{
