...
{
if (param_70<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_237=fast::max(param_71,float4(0.0));
float4 param_72=l9_237;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_72.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_74,param_75,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_76=FinalColor;
float4 l9_305=param_76;
if (sc_ShaderCacheConstant_tmp!=0)
{
